...
const pupa = __nccwpck_require__(491)
...
const {htmlEscape} = __nccwpck_require__(743);
...
(function () {
   ...
   var debug = __nccwpck_require__(237)('simple-git');
   var deferred = __nccwpck_require__(299);
   var exists = __nccwpck_require__(153);
   var NOOP = function () {};
   var responses = __nccwpck_require__(301);
...
var Git = __nccwpck_require__(966);

module.exports = function (baseDir) {

   var dependencies = __nccwpck_require__(164);
...
var DiffSummary = __nccwpck_require__(286);
...
var PullSummary = __nccwpck_require__(629);
...
var FileStatusSummary = __nccwpck_require__(172);
...
module.exports = {
   ...
   BranchSummary: __nccwpck_require__(783),
   CommitSummary: __nccwpck_require__(921),
   DiffSummary: __nccwpck_require__(286),
   FetchSummary: __nccwpck_require__(169),
   FileStatusSummary: __nccwpck_require__(172),
   ListLogSummary: __nccwpck_require__(507),
   MergeSummary: __nccwpck_require__(192),
   MoveSummary: __nccwpck_require__(502),
   PullSummary: __nccwpck_require__(629),
   StatusSummary: __nccwpck_require__(789),
   TagList: __nccwpck_require__(68),
};
...
module.exports = {
   ...
   exists: __nccwpck_require__(153)
...
/* harmony import */ var extract_pr_titles__WEBPACK_IMPORTED_MODULE_1__ = __nccwpck_require__(185);
...
/* harmony import */ var simple_git__WEBPACK_IMPORTED_MODULE_2__ = __nccwpck_require__(477);
...
const logHandler = (err, result) => {
  ...
  result.all.forEach(log => _actions_core__WEBPACK_IMPORTED_MODULE_0__.info(log))
